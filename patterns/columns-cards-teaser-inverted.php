 ...
 */
?>
<!-- wp:group {"metadata":{"name":"Carte de présentation","categories":["cards"],"patternName":"cards-teaser"},"style":{"border":{"radius":{"topLeft":"var:preset|border-radius|m","topRight":"var:preset|border-radius|m","bottomLeft":"var:preset|border-radius|m","bottomRight":"var:preset|border-radius|m"}},"spacing":{"padding":{"top":"var:preset|spacing|s","bottom":"var:preset|spacing|s","left":"var:preset|spacing|s","right":"var:preset|spacing|s"}},"dimensions":{"minHeight":"100%"}},"backgroundColor":"gray","layout":{"type":"flex","orientation":"vertical","justifyContent":"stretch"}} -->
